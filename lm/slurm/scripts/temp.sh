...
#SBATCH --ntasks 8
#SBATCH --nodes=1
#SBATCH --output="/lustre/scratch/grp/fslg_internn/internn/lm/slurm/scripts/log_temp.slurm"
...
which python
python -u /lustre/scratch/grp/fslg_internn/internn/lm/train_BERT.py --config '/lustre/scratch/grp/fslg_internn/internn/lm/configs/temp.yaml'
