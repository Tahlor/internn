...
#SBATCH --ntasks 8
#SBATCH --nodes=1
#SBATCH --output="/lustre/scratch/grp/fslg_internn/internn/lm/slurm/scripts/log_02_lm_config_EMBEDDING.slurm"
...
which python
python -u /lustre/scratch/grp/fslg_internn/internn/lm/train_BERT.py --config '/lustre/scratch/grp/fslg_internn/internn/lm/configs/02_lm_config_EMBEDDING.yaml'
