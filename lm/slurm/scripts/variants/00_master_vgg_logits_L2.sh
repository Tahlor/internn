...
which python
python -u /lustre/scratch/grp/fslg_internn/internn/lm/train_BERT.py '/lustre/scratch/grp/fslg_internn/internn/lm/configs/variants/00_master_vgg_logits_L2.yaml'
